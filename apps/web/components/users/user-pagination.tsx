...
/**
 * Pagination controls for the user directory.
 *
 * Shows the record range as well as the page number, because "showing 21–40 of
 * 137" answers the question an administrator actually has — how much of the
 * directory they are looking at — which "page 2 of 7" does not.
 *
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
      <p className="text-sm text-muted-foreground" aria-live="polite">
        {totalRecords === 0
          ? "No users"
          : `Showing ${first}–${last} of ${totalRecords} user${totalRecords === 1 ? "" : "s"}`}
      </p>
